...
const officialReports = [
  // `docx: true` → tersedia unduhan Word (.docx) editable pada baris "Versi Word".
  ...
  return (
    <>
      ...
      <div className="border-t border-border pt-3 space-y-2">
        <div className="flex gap-2 items-stretch">
          <button data-testid="download-lhi" onClick={() => onDownloadPDF("lhi")} disabled={!!downloading}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-teal-600 via-teal-700 to-cyan-700 hover:from-teal-700 hover:via-teal-800 hover:to-cyan-800 disabled:from-teal-300 disabled:via-teal-300 disabled:to-cyan-300 dark:from-teal-700 dark:via-teal-800 dark:to-cyan-800 dark:hover:from-teal-600 dark:hover:via-teal-700 dark:hover:to-cyan-700 text-white rounded-lg text-sm font-semibold transition-all shadow-sm">
      ...
      <div className="border-t border-border pt-3">
        ...
        {onDownloadDocx && officialReports.some(r => r.docx) && (
