  ...
  <header className="bg-card/95 backdrop-blur-sm border-b border-border px-3 sm:px-4 py-2.5 sticky top-0 z-40 print:hidden" data-testid="dashboard-header">
    <div className="flex items-center justify-between gap-2 min-w-0">
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        ...
        <Button variant="outline" size="sm" onClick={onLogout} className="h-7 gap-1 text-xs"><LogOut className="w-3 h-3" /><span className="hidden sm:inline">Keluar</span></Button>
      </div>
    </div>
  </header>
));
