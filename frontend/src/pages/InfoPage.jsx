      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10 overflow-x-clip">
        ...
        <CollapsibleSection id="fitur" title="Fitur & Fungsionalitas (Siklus Penuh BMN)" icon={Layers}>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <FeatureCard icon={MapPinned} title="Peta Aset & Ekspor GIS" description="Lembar peta interaktif di halaman utama — mengikuti pencarian & filter aktif, jalan penuh saat offline" color="teal" items={["Pin status berwarna + badge foto + border hijau kelengkapan pengguna/BAST", "Desain pin per aset/massal: 28 ikon berkategori + pencarian, huruf/angka, unggah ikon standar, lingkaran & garis tepi; ikut peta dibagikan dan luring", "Geser pin = koordinat tersimpan otomatis (aman konflik)", "Filter Barang Serupa + unduh KML/KMZ/SHP (27 atribut, WGS84)"]} />
