...
// "Sudah Diinventarisasi". Kerja lapangan berjalan cepat: surveyor cukup memotret
// + kunci GPS tanpa harus mengetuk status. Bisa dimatikan pengguna via
// localStorage `aman_auto_inventarisasi` = "off" (default AKTIF).
//
...
export const STATUS_SUDAH = "Sudah Diinventarisasi";
...
// Murni: kembalikan status inventarisasi EFEKTIF. Naikkan ke "Sudah
// Diinventarisasi" HANYA bila fitur aktif, ada foto, ada koordinat (lat & lng),
// dan status masih default "Belum Diinventarisasi"/kosong. Status apa pun yang
// sudah diubah manual (mis. "Tidak Ditemukan", "Berlebih", "Sengketa") TAK PERNAH
// diubah — kembalikan apa adanya.
