...
export const PENATAUSAHAAN_SUBMODULES = [
  ...
  },
  {
    ...
    status: "sebagian",
    fase: 2,
    ringkas: "Hub arsip, LBKP, Posisi BMN di Neraca, dan rekonsiliasi XLSX sudah bisa dibuka — CaLBMN & LKB menyusul.",
    deskripsi:
...
export const SIKLUS_MODULES = [
  ...
  },
  {
    ...
    fitur: [
      ...
      "Pengajuan & SK Penetapan Status Penggunaan (PSP) — menyusul",
      "Alih status, penggunaan sementara, dioperasikan pihak lain, penggunaan bersama (menyusul)",
      "Pemantauan & tindak lanjut BMN idle (menyusul)",
    ],
  ...
  },
  {
    ...
    fitur: [
      ...
      "Arsip dokumen perjanjian per aset (menyusul)",
    ],
