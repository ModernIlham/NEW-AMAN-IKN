...
export const SIKLUS_MODULES = [
  {
    ...
    fitur: [
      ...
      "✅ Register usulan RKBMN per unit berstatus (draft → diajukan → …; SPTJM & reviu APIP tercatat) + tautan aset",
      "✅ Analisis SBSK (PMK 138/2024): tabel standar barang & kebutuhan konfigurabel (seed + rawat admin) dipakai sanding per usulan",
      "✅ Sanding usulan vs aset eksisting: jumlah sejenis, sebaran kondisi, umur rata-rata, nilai + catatan analisis otomatis untuk reviewer",
    ],
  ...
  },
  {
    ...
    fitur: [
      ...
      "✅ Auto-daftar draft aset baru dari barang perolehan belum tertaut (pilih kegiatan, NUP berurut)",
    ],
  ...
  },
  {
    ...
    fitur: [
      ...
      "✅ Transfer masuk alih status: barang dari Pengguna Barang lain dibukukan manual — aset lahir otomatis + jurnal 102",
      "✅ Henti guna mandiri ber-SK/BA di luar jalur idle: dihentikan → digunakan kembali + jurnal 401/402",
    ],
  ...
  },
  {
    ...
    fitur: [
      ...
      "✅ Penyusutan garis lurus semesteran per golongan (PMK 65/2017; Tabel I LENGKAP KMK 295/2019 jo. 266/2023 jo. 339/2024) + daftar telaah",
      "✅ Referensi masa manfaat dapat dikelola + diperbarui otomatis dari kolom Umur Aset tiap impor SIMAN V2",
      "✅ Masa manfaat bertambah otomatis dari perbaikan ber-BA (Tabel II KMK — via modul Pemeliharaan)",
  ...
  },
  {
    ...
    fitur: [
      ...
      "✅ Posting pengembangan nilai (jurnal 202) + Berita Acara Perbaikan PDF",
      "✅ Perbaikan menambah umur: tambahan masa manfaat otomatis per Tabel II KMK 295/2019 jo. 266/2023 jo. 339/2024 (diakui saat BA serah terima)",
    ...
    integrasi: [
      "Riwayat biaya menjadi dasar usulan RKBMN pemeliharaan (Perencanaan)",
      "Kapitalisasi perbaikan menambah nilai aset (Pembukuan) & masa manfaat penyusutan (Penilaian/DBKP/LBP)",
    ],
  },
  {
    id: "pemindahtanganan",
    ...
    fitur: [
      ...
      "✅ Aset otomatis keluar dari daftar aktif setelah usulan selesai (proyeksi ke master aset)",
    ],
  ...
  },
  {
    ...
    fitur: [
      ...
      "✅ Register TGR aset hilang (PP 38/2016): penelusuran → telaah TPKN → TGR ditetapkan/bebas → lunas, dokumen wajib per keputusan",
      "✅ Gerbang SK jalur Tidak Ditemukan: SK penghapusan aset hilang ditolak selama proses TGR belum berkeputusan",
    ],
  ...
  },
  {
    ...
    fitur: [
      ...
      "✅ Laporan Tahunan Wasdal (struktur Lampiran PMK 207/2021): pemantauan per objek + penertiban & tindak lanjut + insidentil + portofolio BMN — PDF siap tanda tangan",
      "✅ Portofolio aset & analisis SBSK: rekap per golongan + indikator tertib (PSP/idle/sengketa) + tabel standar PMK 138/2024",
    ],
