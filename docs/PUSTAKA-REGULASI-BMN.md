...
| Pengadaan (F4, ✅ tahap awal) | ✅ Register perolehan per BAST/kontrak (jenis 101/102/103/105) + checklist dokumen sumber + tautan aset + penanda ekstrakomptabel PMK 181 (#117, §10) + arsip lampiran (#135) + ekspor CSV (#161) + tautan paket → usulan Penganggaran (#199, jembatan #117↔#115); pencatatan resmi di SAKTI; menyusul: auto-daftar draft aset |
