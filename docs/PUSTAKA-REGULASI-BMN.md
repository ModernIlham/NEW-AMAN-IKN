...
| Pengamanan (F3, ✅ tahap awal) | ✅ Dasbor tertib administrasi + pantau sengketa dari data inventarisasi (#88); ✅ register BMN bermasalah berstatus identifikasi→mediasi→blokir→litigasi→selesai (#169, §11); ✅ arsip dokumen kepemilikan per aset + lokasi penyimpanan Ps. 43 + scan (#171); ✅ status sertipikasi K1-K4 per dokumen sertipikat (#173); menyusul: checklist pengamanan per jenis |
