...
AMAN_USERNAME=penguji-staging@contoh.go.id AMAN_PASSWORD='<dari brankas>' \
...
|---|---|---|
| `AMAN_USERNAME` / `AMAN_PASSWORD` | kredensial akun uji/staging | **Wajib — tanpa bawaan; kosong = harness berhenti** |
