...
ASSET_TEMPLATE_SCHEMA = [
    ...
    {"field": "eselon3", "required": False, "width": 18,
     "rule": "Unit Eselon III (opsional).",
     "sample1": "Bagian Rumah Tangga", "sample2": "Subdirektorat A", "dropdown": None},
    {"field": "eselon4", "required": False, "width": 18,
     "rule": "Unit Eselon IV (opsional).",
     "sample1": "Subbagian Perlengkapan", "sample2": "Seksi Satu", "dropdown": None},
    {"field": "eselon5", "required": False, "width": 18,
     "rule": "Unit Eselon V (opsional).",
     "sample1": "Urusan Gudang", "sample2": "Urusan Arsip", "dropdown": None},
    ...
    {"field": "cara_bayar_kontrak", "required": False, "width": 22,
     "rule": "Cara pembayaran kontrak: Sekaligus / Bertahap (Termin).",
     "sample1": "Sekaligus", "sample2": "Bertahap (Termin)",
     "dropdown": ["Sekaligus", "Bertahap (Termin)"]},
