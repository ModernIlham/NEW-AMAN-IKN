...
def build_asset_search_query(
    ...
    for field, klausa in (
        ...
        ("eselon3", klausa_substring(eselon3_filter)),
        ("eselon4", klausa_substring(eselon4_filter)),
        ("eselon5", klausa_substring(eselon5_filter)),
    ):
...
async def kueri_aset_terlihat(
    ...
    *,
    ...
    query = build_asset_search_query(
        ...
        eselon3_filter=eselon3_filter, eselon4_filter=eselon4_filter,
        eselon5_filter=eselon5_filter,
...
async def get_assets(
    ...
    sort = ASSET_SORT_OPTIONS.get(sort_by, [("created_at", -1)])
...
async def get_filter_options(activity_id: str = "", _user: dict = Depends(require_user)):
    ...
    (locations, eselon1s, eselon2s, eselon3s, eselon4s, eselon5s, conditions,
     ...
     categories, eselon_jalur) = await asyncio.gather(
        ...
        db.assets.distinct("eselon3", query),
        db.assets.distinct("eselon4", query),
        db.assets.distinct("eselon5", query),
