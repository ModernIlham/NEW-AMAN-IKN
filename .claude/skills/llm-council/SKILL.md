...
> **Asal-usul & modifikasi lokal** — skill ini BUKAN buatan proyek AMAN.
>
> - Sumber: <https://github.com/aiwithremy/claude-skills-llm-council>
>   (commit `55ee36e`, 2026-04-26), penulis Ole Lehmann / Remy Gaskell.
> - Metodologi diadaptasi dari LLM Council milik Andrej Karpathy
>   (<https://github.com/karpathy/llm-council>).
> - Repo sumber TIDAK mencantumkan lisensi. Disalin ke sini karena repo itu
>   memang diterbitkan untuk dibagikan; bila pemiliknya keberatan, hapus
>   berkas ini.
> - Diambil 2026-08-16 atas permintaan pemilik proyek agar tetap tersedia di
>   sesi-sesi berikutnya (kontainer sesi bersifat sementara).
>
> Dua penyesuaian terhadap naskah aslinya, keduanya disengaja:
>
> 1. Frontmatter dirapikan ke bentuk baku (nilainya tidak diubah).
> 2. Catatan penutup aslinya berbunyi "buat keluaran HTML yang rapi",
>    bertentangan dengan langkah 5 yang memerintahkan menampilkan hasil di
>    chat TANPA berkas. Yang bertentangan itu diselaraskan ke langkah 5.
>
> Catatan biaya: sekali jalan memanggil 11 sub-agen (5 penasihat + 5
> peninjau + 1 ketua). Pakai untuk keputusan bertaruh tinggi, bukan
> pertanyaan biasa.
...
- **The verdict must be scannable.** Most users skim the verdict rather than read every advisor response. Keep the chat output tight and use bullets. (Modifikasi lokal — lihat catatan asal-usul di atas.)
